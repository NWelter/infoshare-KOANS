...
public class AboutStrings {
    ...
    public void stringStartsWith() {
        ...
        assertEquals("one is the number".startsWith("one"), "one is the number".startsWith("one"));
        assertEquals("ONE is the number".startsWith("one"), "ONE is the number".startsWith("one"));
    }
    ...
    public void stringEndsWith() {
        ...
        assertEquals("the number is one".endsWith("one"), "the number is one".endsWith("one"));
        assertEquals("the number is two".endsWith("one"), "the number is two".endsWith("one"));
        assertEquals("the number is One".endsWith("one"), "the number is One".endsWith("one"));
    }
