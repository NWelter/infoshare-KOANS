...
public class AboutPrimitives {
    ...
    public void charsCanOnlyBePositive() {
        ...
        //(Values of characters are presented in UNICODE) Character.MIN_VALUE == '\u0000'
        //Character.MAX_VALUE == '\uFFFF'
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        //e (or E ="exponent" - wykładnik potęgi, używany w notacji naukowej)
        //1e3 == 1 x 10^3
        //1E-2 == 1 x 10^-2
    }
    ...
    public void primitivesOfTypeFloatCanBeDeclaredWithExponents() {
        ...
        //you must add char 'f' to identify float type
    ...
    public void floatsHaveASmallerRangeThanDoubles() {
        ...
        assertEquals(Float.MAX_VALUE, 3.40282346638528860e+38f);
    }
